...
public class OperationsProcessorTest {
    ...
    public void init() throws IOException {
        ...
        victim = new OperationsProcessor(NAMESPACE, validator, Arrays.asList(type1, type2));
    }
    ...
    public void shouldSuccessfullyProcessOperations() {
        ...
        try {
            ...
            List<OperationOutputInterface> operationOutputInterfaces = victim.process(serviceDefinition);
